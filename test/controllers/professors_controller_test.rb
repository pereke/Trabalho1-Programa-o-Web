...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { email: @professor.email, formacao: @professor.formacao, nomeProfessor: @professor.nomeProfessor, sala: @professor.sala, telefone: @professor.telefone } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { email: @professor.email, formacao: @professor.formacao, nomeProfessor: @professor.nomeProfessor, sala: @professor.sala, telefone: @professor.telefone } }
