...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { inicio: @projeto.inicio, nomeProjeto: @projeto.nomeProjeto, resumo: @projeto.resumo, termino: @projeto.termino } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { inicio: @projeto.inicio, nomeProjeto: @projeto.nomeProjeto, resumo: @projeto.resumo, termino: @projeto.termino } }
