...
class PublicacaosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create publicacao" do
    assert_difference('Publicacao.count') do
      post publicacaos_url, params: { publicacao: { arquivoBib: @publicacao.arquivoBib, categoria: @publicacao.categoria, nomePublicacao: @publicacao.nomePublicacao } }
    end
  ...
  test "should update publicacao" do
    patch publicacao_url(@publicacao), params: { publicacao: { arquivoBib: @publicacao.arquivoBib, categoria: @publicacao.categoria, nomePublicacao: @publicacao.nomePublicacao } }
