...
class AlunosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aluno" do
    assert_difference('Aluno.count') do
      post alunos_url, params: { aluno: { categoria: @aluno.categoria, curso: @aluno.curso, idAluno: @aluno.idAluno, nome: @aluno.nome } }
    end
  ...
  test "should update aluno" do
    patch aluno_url(@aluno), params: { aluno: { categoria: @aluno.categoria, curso: @aluno.curso, idAluno: @aluno.idAluno, nome: @aluno.nome } }
