...
class AulasControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create aula" do
    assert_difference('Aula.count') do
      post aulas_url, params: { aula: { categoria: @aula.categoria, nomeAula: @aula.nomeAula, quantidade: @aula.quantidade } }
    end
  ...
  test "should update aula" do
    patch aula_url(@aula), params: { aula: { categoria: @aula.categoria, nomeAula: @aula.nomeAula, quantidade: @aula.quantidade } }
